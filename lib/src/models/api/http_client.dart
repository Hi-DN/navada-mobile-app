...
class HttpClient {
  ...
  Future<Map<String, dynamic>> getRequest(String url, {bool tokenYn = false}) async {
  ...
  Future<Map<String, dynamic>> postRequest(String url, Map<String, dynamic> body, {bool tokenYn = false}) async {
    http.Response response;
  ...
  Future<Map<String, dynamic>> putRequest(String url, Map<String, dynamic> body,{bool tokenYn = false}) async {
    http.Response response;
    Map<String, String> headers;
    try {
      if (tokenYn) {
  ...
  Future<Map<String, dynamic>> deleteRequest(String url, {bool tokenYn = false}) async {
    http.Response response;
    Map<String, String> headers;
  ...
  Future<Map<String, dynamic>> patchRequest(String url, Map<String, dynamic> body, {bool tokenYn = false}) async {
    http.Response response;
    Map<String, String> headers;
  ...
  Future<void> getNewAccessToken() async {
    try {
      ...
      navigatorKey.currentState?.pushNamedAndRemoveUntil(SignIn.routeName, (route) => false);
    }
  }
