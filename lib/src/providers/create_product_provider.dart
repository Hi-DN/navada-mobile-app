...
class CreateProductProvider extends ChangeNotifier {
  ...
  setProductExchangeCost(int productExchangeCost) {
    _productExchangeCost = productExchangeCost;
  }
  ...
  Future<ProductSearchPageModel> getProductsBySearchWord(
      String? searchWord, int pageNum) async {
    ProductSearchPageModel? pageResponse = await _productService.searchProducts(
        _userId, searchWord, [], null, null, false, [0], null, pageNum);
