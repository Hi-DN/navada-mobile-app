...
class ExchangeConfirmModal extends StatelessWidget {
    ...
    return MultiProvider(
        providers: [
          ChangeNotifierProvider(
              create: (context) => CompleteExchangeProvider()),
        ],
        child: Container(
  ...
  Widget _completeExchangeBtn(ExchangeDtoModel? exchange) {
    ...
    return Consumer2<ExchangeDetailViewModel, CompleteExchangeProvider>(builder:
        (BuildContext context, ExchangeDetailViewModel viewModel,
            CompleteExchangeProvider provider, Widget? _) {
        ...
        children: [
          LongCircledBtn(
            onTap: () async {
              if (!isInitial) {
                await provider
                    .completeExchange(exchange.exchangeId, isAcceptor,
                        hasConfirmedRating, rating)
                    .then((value) {
      ...
      return RatingBar(
        ...
        ratingWidget: RatingWidget(
          ...
          empty: Icon(Icons.star_border_outlined,
              color: isStarGrey ? grey216 : green),
        ),
